...
var.2007.8.df.cut<-subset(var.2007.8.df,!(Id==34 & run=="Run_1293"))
...
var.other.seasons.df.cut<-subset(var.other.seasons.df,!(Id==530 & run=="Run_1412"))

var.other.seasons.df.cut<-subset(var.other.seasons.df.cut,!(Id==529 & run=="Run_1412"))
