...
```{r}
ggplot(subset(all.df,freq.var<=0.99),aes(x=freq.var))+geom_histogram(color="white",binwidth = 0.01)+scale_y_log10() + ggtitle("All samples")
ggplot(subset(all.qual.df,freq.var<=0.99),aes(x=freq.var))+geom_histogram(color="white",binwidth = .01)+scale_y_log10() + ggtitle("Only high quality samples")
